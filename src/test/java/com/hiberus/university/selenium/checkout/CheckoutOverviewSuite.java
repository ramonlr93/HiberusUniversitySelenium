...
public class CheckoutOverviewSuite {
    ...
    public void continueTest() {
        ...
        Assert.assertEquals("CONTINUE FAILED", checkoutOverviewPage.getSumPrices().toString(), checkoutOverviewPage.getItemTotal().substring(13));
    }
    ...
    public void clickCancelTest() {
        ...
        Assert.assertEquals("CONTINUE FAILED", InventoryPage.PAGE_URL, driver.getCurrentUrl());
    }
