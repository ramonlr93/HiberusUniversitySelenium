...
public class RegisterPageSteps {
    ...
    public void theUserFillsTheFirstname(String firstname) {
        registerPage.enterFirstname(firstname);
    }

    @And("the user fills the lastname {string}")
    public void theUserFillsTheLastname(String lastname) {
        registerPage.enterLastname(lastname);
    }

    @And("the user fills the telephone {string}")
    public void theUserFillsTheTelephone(String telephone) {
        registerPage.enterTelephone(telephone);
    }

    @And("the user fills the pass {string}")
    public void theUserFillsThePass(String password) {
        registerPage.enterPassword(password);
    }

    @And("the user fills the confirm {string}")
    public void theUserFillsTheConfirm(String confirm) {
        registerPage.enterConfirm(confirm);
    }
