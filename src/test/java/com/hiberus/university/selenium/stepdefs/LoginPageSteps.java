...
public class LoginPageSteps {
    ...
    public void theUserProvidesTheUsername(String username) {
        PagesFactory pf = PagesFactory.getInstance();
        log.info("The user provides de username");
        LoginPage loginPage = pf.getLoginPage();
    ...
    public void theClicksTheLoginButton() {
        PagesFactory pf = PagesFactory.getInstance();
    ...
    public void theUserLoggedInSuccesfully() {
        PagesFactory pf = PagesFactory.getInstance();
        log.info("The user logged in succesfully and is in the inventory page");
    ...
    public void aMessageErrorShouldBeShown() {
        PagesFactory pf = PagesFactory.getInstance();
