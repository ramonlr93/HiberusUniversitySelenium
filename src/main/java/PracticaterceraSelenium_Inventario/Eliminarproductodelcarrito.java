...
public class Eliminarproductodelcarrito {
    ...
    public static void main(String[] args) {
        ...
        WebElement element2 = driver.findElement(By.id("add-to-cart-sauce-labs-onesie"));
        element2.click();


        // Paso 6 Eliminar producto del carrito
        WebElement element3 = driver.findElement(By.id("remove-sauce-labs-onesie"));
        element3.click();

        // Paso 7 Validar que el icono del carrito se ha eliminado el producto
    }
}
