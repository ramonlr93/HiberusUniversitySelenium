...
public class CheckoutSuiteTest {
    ...
    public void checkPriceProductsTest() {
        ...
        // Realizar el checkout.feature del producto
        driver.findElement(By.id("checkout.feature")).click();

        // Rellenar datos del checkout.feature y continuar.
